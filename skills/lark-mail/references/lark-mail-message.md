...
```json
{
  ...
  "subject":                  "邮件主题",
  "head_from":                {"mail_address": "user@example.com", "name": "Alice"},
  "to":                       [{"mail_address": "user@example.com", "name": "Bob"}],
  "cc":                       [{"mail_address": "user@example.com", "name": "Carol"}],
  "bcc":                      [],
  ...
  "security_level": {
    ...
    "spam_user_rule_id": "76138000000005388",
