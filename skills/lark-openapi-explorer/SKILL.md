...
version: 1.0.0
description: "飞书/Lark 原生 OpenAPI 探索：从官方文档库挖掘未经 CLI 封装的原生 API 接口。触发：existing lark-* skills or lark-cli commands cannot fulfill the requirement, or user asks to call a specific Feishu OpenAPI. 需要lark-cli configured. 不适用于：common operations covered by lark-* skills, or non-Feishu APIs."
metadata:
  requires:
    bins: ["lark-cli"]
---
